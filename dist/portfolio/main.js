...
const userAction = document.querySelector('.user__action');
const userInfo = document.querySelector('.user__info');
const screenWidth = screen.width;
const userCheck = () => __awaiter(void 0, void 0, void 0, function* () {
    const token = localStorage.getItem('token');
    const userId = localStorage.getItem('userId');
    if (token) {
        try {
            const userProfileResponse = yield fetch(`${apiUrl}api/auth/user/${userId}`, {
                headers: {
            ...
            if (userProfileResponse.ok) {
                ...
                const userActionCloseBtn = document.querySelector('.user__action--close-btn');
                ...
                profileImage.addEventListener('click', (event) => {
                    ...
                    const photo = document.querySelector('.user__info_form #photo');
                    ...
                    const updateBtn = document.querySelector('.user__info_form .update-btn');
                    ...
                    let editUserImageUrl;
                    userProfile === null || userProfile === void 0 ? void 0 : userProfile.addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () {
                        try {
                            const userDataResponse = yield fetch(`${apiUrl}api/auth/user/${userId}`, {
                                headers: {
                                    "Authorization": `Bearer ${token}`
                                }
                            });
                    ...
                    userInfoForm === null || userInfoForm === void 0 ? void 0 : userInfoForm.addEventListener('submit', (e) => __awaiter(void 0, void 0, void 0, function* () {
                        e.preventDefault();
                        ...
                        try {
                            const updateDataResponse = yield fetch(`${apiUrl}api/auth/user/${userId}`, {
                                method: 'PUT',
                                headers: {
                                    "Authorization": `Bearer ${token}`
                                },
