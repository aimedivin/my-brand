...
const blogDataFetch = (blogId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const blogResponse = yield fetch(`${apiUrl}api/portfolio/blog/${blogId}`);
        if (blogResponse.ok) {
            const blogData = yield blogResponse.json();
...
const userLikeFetch = (blogId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const token = localStorage.getItem('token');
        const blogUserLikeResponse = yield fetch(`${apiUrl}api/portfolio/blog/${blogId}/like`, {
            headers: {
...
const blogCommentFetch = (blogId) => __awaiter(void 0, void 0, void 0, function* () {
    let blogComments = '';
    const commentResponse = yield fetch(`${apiUrl}api/portfolio/blog/${blogId}/comment`);
    const comments = [];
    if (commentResponse.ok) {
        const commentCreator = (yield commentResponse.json()).comments;
...
const singleBlog = (arr) => {
    ...
    Array.from(arr).forEach((el, index) => {
        el.addEventListener('click', (e) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const blogTarget = e.target;
            const blogIndex = blogIdForm[index].firstElementChild.value;
            const response = yield fetch(`${apiUrl}api/portfolio/blog/${blogIndex}`);
            if (!response.ok) {
                return;
            }
            ...
            // BLOG COMMENTS RETRIEVAL
            blogComments = yield blogCommentFetch(blogIndex);
            // FETCHING LIKE FOR SPECIFIC USER
            const userLike = yield userLikeFetch(blogData._id);
            ...
            likeBtn === null || likeBtn === void 0 ? void 0 : likeBtn.addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () {
                try {
                    const blogLikeCount = document.querySelector('.blog--like .blog__view_count');
                    const token = localStorage.getItem('token');
                    const blogLikeResponse = yield fetch(`${apiUrl}api/portfolio/blog/${blogData._id}/like`, {
                        method: "POST",
                        headers: {
                            "Authorization": `Bearer ${token}`
                        },
                    ...
                    if (blogLikeResponse.ok) {
                        blogData_Like = yield blogDataFetch(blogData._id);
                        if (blogData_Like) {
                        ...
                        const blogDeleteLikeResponse = yield fetch(`${apiUrl}api/portfolio/blog/${blogData._id}/like`, {
                            method: "DELETE",
                            headers: {
                                "Authorization": `Bearer ${token}`
                            },
            ...
            const blogCommentForm = document.querySelector('.blog__comment_new');
            blogCommentForm.addEventListener('submit', (e) => __awaiter(void 0, void 0, void 0, function* () {
                e.preventDefault();
                const blogCommentsContainer = document.querySelector('.blog__comments');
                // Accessing form data
                ...
                const token = localStorage.getItem('token');
                try {
                    const response = yield fetch(`${apiUrl}api/portfolio/blog/${blogId}/comment`, {
                        method: "POST",
                        headers: {
                    ...
                    if (!token) {
                        ...
                        const blogComments = yield blogCommentFetch(blogIndex);
...
window.addEventListener('load', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const response = yield fetch(`${apiUrl}api/portfolio/blogs`);
        if (!response.ok) {
            return;
        }
        ...
        for (let i = 0; i < blogs.blogs.length; i++) {
            ...
            ${date.getDate()}-${months[date.getMonth()]}-${date.getFullYear()}`;
            const userLike = yield userLikeFetch(blogs.blogs[i]._id);
        ...
        blogsBtn.addEventListener('click', (e) => __awaiter(void 0, void 0, void 0, function* () {
            e.preventDefault();
            const response = yield fetch(`${apiUrl}api/portfolio/blogs`);
            if (!response.ok) {
                return;
